    ...
    <section className="pt-6 pb-16 md:pt-8 md:pb-20">
      <div className="mx-auto max-w-7xl px-6">
        <h2 className="text-muted-foreground max-w-4xl text-balance text-4xl font-medium tracking-tight lg:text-5xl">
          <span className="text-foreground">Organization, Fundraisers.</span>{" "}
          <br /> One timeline per customer.
        </h2>
        <div className="*:bg-background mt-8 grid gap-3 md:mt-16 md:grid-cols-2 lg:grid-cols-3">
          <Card className="p-8">
            <p className="text-muted-foreground max-w-xs text-lg font-medium">
              <span className="text-foreground">
                Account ownership, clarified.
              </span>{" "}
              Know who owns each relationship and what happened last.
            </p>
          ...
          <Card>
            <div className="p-8">
              <p className="text-muted-foreground max-w-xs text-lg font-medium">
                ...
                Tasks and reminders tied to real deal momentum, not busywork.
              </p>
            </div>
          ...
          <Card className="p-8">
            <p className="text-muted-foreground max-w-xs text-lg font-medium">
              <span className="text-foreground">Revenue teams aligned.</span>{" "}
              Sales and success share one timeline per customer, from first
              touch to renewal.
            </p>
        ...
        <div className="max-sm:*:not-last:border-b max-sm:*:not-last:pb-3 mt-12 grid gap-3 *:max-w-xs sm:grid-cols-2 md:mt-16 md:gap-y-6 lg:mt-24 lg:grid-cols-4 lg:gap-6">
          <p className="text-muted-foreground text-balance">
            <span className="text-foreground font-medium">
              <ArrowLeftRight className="inline size-4 -translate-y-0.5" /> Lead
              routing.
            </span>{" "}
          ...
          <p className="text-muted-foreground text-balance">
            <span className="text-foreground font-medium">
              <Bell className="inline size-4 -translate-y-0.5" /> Activity
              tracking.
            </span>{" "}
          ...
          <p className="text-muted-foreground text-balance">
            <span className="text-foreground font-medium">
              <Users className="inline size-4 -translate-y-0.5" /> Renewal
              visibility.
            </span>{" "}
          ...
          <p className="text-muted-foreground text-balance">
            <span className="text-foreground font-medium">
              <LineChart className="inline size-4 -translate-y-0.5" /> Rep
              focus.
            </span>{" "}
